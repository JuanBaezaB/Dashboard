...
<template>
    ...
    <div id="sidebar" class="fixed inset-0 z-40 flex ">
        <div
            class="relative flex w-full flex-1 flex-col pt-5 pb-4 transition-colors duration-500 bg-white dark:bg-gray-800 border-slate-200 lg:border-slate-900/10 dark:border-slate-50/[0.06] border-r">
