<template>
    <div
        class="flex flex-col items-center justify-center min-h-screen text-gray-700 p-10 bg-gradient-to-br from-pink-200 via-purple-200 to-indigo-200 ">
...
export default {
    ...
    mounted() {
        axios
            .get('https://api.openweathermap.org/data/2.5/weather?lat=-36.615834345823934&lon=-72.11189288681959&appid=e7443274d807bea0d2da7d3d7edf8965&units=metrichttps://api.openweathermap.org/data/2.5/weather?lat=-36.615834345823934&lon=-72.11189288681959&appid=e7443274d807bea0d2da7d3d7edf8965&units=metric&lang=es')
